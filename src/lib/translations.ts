...
const en = {
  ...
  borrowerPhoneLabel: 'Phone Number *',
  borrowerPhonePlaceholder: 'Phone number',
  multipleNamesTitle: 'Multiple Names Found',
  multipleNamesMsg1: 'This phone number has multiple names on file:',
  multipleNamesMsg2: 'as the main name for all existing records with this phone number?',
  setMainName: 'Set as Main Name',
  ...
  borrowerPhoneRequired: 'Phone number is required',
...
const th: typeof en = {
  ...
  borrowerPhoneLabel: 'เบอร์โทร *',
  borrowerPhonePlaceholder: 'เบอร์โทร',
  multipleNamesTitle: 'พบชื่อผู้ยืมหลายชื่อ',
  multipleNamesMsg1: 'เบอร์โทรนี้มีชื่อผู้ยืมหลายชื่ออยู่ในระบบ:',
  multipleNamesMsg2: 'เป็นชื่อหลักสำหรับบันทึกทั้งหมดที่ใช้เบอร์นี้หรือไม่?',
  setMainName: 'ตั้งเป็นชื่อหลัก',
  ...
  borrowerPhoneRequired: 'กรุณากรอกเบอร์โทร',
